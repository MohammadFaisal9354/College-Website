<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showpoorapage.aspx.cs" Inherits="showpoorapage" %>
...
<center>
    ...
    <!-- End of body section HTML codes -->
     ...
     <div id="menup" class="animated flip">
<ul>
  ...
  <li><a href="userlogin.aspx">User Login</a></li>
   ...
   <div id="extrap">
    ...
    <div id="bodyfullp" class="style2">
       
     
       <div id="bbbbbbbb" align="center" 
            style="font-size: large; font-weight: bold; text-decoration: underline">
           <br />
           Registeration Of Students<br />
       </br>
           <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
               GridLines="None" Width="1266px">
    ...
    <div id="bbbbbbbb" align="center" 
            style="font-size: medium; font-weight: bold; text-decoration: underline">
        <br />
        Registeration of Staff/Employees<br />
    </br>
        <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" Width="1271px">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <EditRowStyle BackColor="#999999" />
            <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
