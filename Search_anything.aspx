<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search_anything.aspx.cs" Inherits="Search_anything" %>
        ...
        <table align="left" class="style1">
            <tr>
                ...
                <td align="left" class="style7" colspan="2" 
                    ...
                    Search Any thing in Database</td>
                <td class="style7">
                </td>
            </tr>
            <tr>
                ...
                <td align="left" class="style3" style="font-size: large; font-weight: bold">
                    Enter Data</td>
                <td align="left" class="style6" style="font-size: large; font-weight: bold">
                    <asp:TextBox ID="TextBox1" runat="server" Width="256px" 
...
&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td align="center" class="style2" colspan="3">
                    Student Details<asp:GridView ID="GridView1" runat="server" Height="16px" 
                        Width="1170px">
                    </asp:GridView>
                </td>
                <td rowspan="2">
            ...
            <tr>
                <td align="center" class="style2" colspan="3">
                    Employee/Staff Details<asp:GridView ID="GridView2" runat="server" Height="16px" Width="1177px">
                    </asp:GridView>
                </td>
            </tr>
            <tr>
                <td align="center" class="style2" colspan="3">
                    Student Fees Details<br />
                    <asp:GridView ID="GridView3" runat="server" Height="16px" Width="1176px">
                    </asp:GridView>
                </td>
                <td rowspan="2">
                    &nbsp;</td>
            ...
            <tr>
                <td align="center" class="style2" colspan="3">Employee Salary Details<asp:GridView ID="GridView4" runat="server" Height="16px" 
                        onselectedindexchanged="GridView4_SelectedIndexChanged" Width="1180px">
                    </asp:GridView>
                </td>
            </tr>
            </table>
