        ...
        <table align="center" class="style1">
            ...
            <tr>
                <td class="style2">
                    &nbsp;</td>
                <td>
                    <asp:Image ID="Image1" runat="server" Height="242px" ImageUrl="~/images/1.jpg" 
                        Width="497px" />
                </td>
                <td class="style3">
                    &nbsp;</td>
                <td>
                    <asp:Image ID="Image2" runat="server" Height="242px" ImageUrl="~/images/3.jpg" 
                        Width="622px" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="style2">
                    &nbsp;</td>
                <td>
                    <asp:Image ID="Image3" runat="server" Height="242px" ImageUrl="~/images/u.jpg" 
                        Width="524px" />
                </td>
                <td class="style3">
                    &nbsp;</td>
                <td>
                    <asp:Image ID="Image4" runat="server" Height="242px" ImageUrl="~/images/m.jpg" 
                        Width="619px" />
                </td>
            </tr>
        </table>
